...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) define('p5.sound', ['src/p5js/p5'], function (p5) {
    factory(p5);
  });else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') {/*factory(require('src/p5js/p5'));*/} else factory(root['p5']);
})(this, function (p5) {
  /**
  ...
  soundfile = function () {
    ...
    p5.SoundFile.prototype.play = function (time, rate, amp, _cueStart, duration) {
      ...
      if (this.buffer) {
        ...
        var clearOnEnd = function clearOnEnd(e) {
          this._playing = false;
...
//# sourceMappingURL=p5.sound.02eaae13.map